...
Donation.create(quantity_cents: '5000', currency: '€', date: '2004-10-10', project_id: '7', user_id: 1, comment: "Rewind to early 2000's. Chrome didn't exist. Internet Explorer had +90% of browser market share. A free software project to create an alternative browser emerged: Firefox. It slowly started to get supporters while developing a great product. An advocacy campaign was created at spreadfirefox.com. And a crazy idea was proposed: a full page ad in the New York Times crowdfunded with donations to promote the 1.0 version of Firefox. It just happened. A double page ad with more than 10.000 names of the donors in it. Read more at: https://blog.mozilla.org/press/2004/12/mozilla-foundation-places-two-page-advocacy-ad-in-the-new-york-times/ http://tech.slashdot.org/story/04/10/19/1338254/firefox-seeks-full-page-ad-in-new-york-times")

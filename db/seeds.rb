...
Donation.create(quantity_cents: 10030, currency: 'EUR', date: '2014-10-14', project_id: 4, user_id: 7, comment: 'Wadus comment', quantity_privacy: 0)
Donation.create(quantity_cents: 22010, currency: 'EUR', date: '2014-08-08', project_id: 4, user_id: 8, comment: 'Wadus comment', quantity_privacy: 1)
Donation.create(quantity_cents: 2512, currency: 'USD', date: '2014-10-14', project_id: 5, user_id: 1, comment: 'You should donate too!', quantity_privacy: 0)
Donation.create(quantity_cents: 2521, currency: 'EUR', date: '2014-08-08', project_id: 5, user_id: 2, comment: 'Fighting for privacy in the Internet', quantity_privacy: 1)
